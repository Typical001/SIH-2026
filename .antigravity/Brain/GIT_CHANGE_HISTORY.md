...
Uncommitted local changes: `frontend/src/context/AuthContext.jsx`, `frontend/src/components/LoginModal.jsx`, and `frontend/src/utils/pdfGenerator.js` added; `App.jsx`, `Navbar.jsx`, `backend/main.py`, `App.test.jsx`, `RouteComparisonModal.jsx`, `DecisionSupport.jsx`, `package.json`, `package-lock.json`, and the eleven Brain documents updated (including mandatory officer authentication gate).
