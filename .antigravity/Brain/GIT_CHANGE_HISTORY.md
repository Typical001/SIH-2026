...
Refreshed from local Git history on **2026-09-17**, ending at **dccfa3b** on main. Paths in tables are Git-root-relative. Application source/configuration, Brain documents and the parent README are included; vendor directories, executables and generated bytecode are summarized separately in [FILE_INVENTORY.md](FILE_INVENTORY.md).

6097e6c committed the September 14 documentation and fixes; c996de7 redesigned the dashboard, added explanations and removed those fixes/documentation/tests; dccfa3b restored only documentation and two test files. The present documentation reconciliation is uncommitted and recorded in [CHANGELOG.md](CHANGELOG.md).
